...
else if(document.getElementById('fine').value=="")
{
alert("Enter fine anoumt");
return false;
}
else
{
$("#stat").load("extrafine.php",{roll:$("#rollno").val(),fine:$("#fine").val()});
}
}
</script>
<?php
...
<tr><td>Enter the roll no</td><td>:<input type='text' name='rollno' id='rollno' ></td></tr>
<tr><td>Enter Fine Amount</td><td>:<input type='text' name='fine' id='fine' ></td></tr>
