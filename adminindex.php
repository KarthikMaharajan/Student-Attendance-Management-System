...
<div id="login">
<div class="lhead"><a href="#"> ADMIN LOGIN </a></div>
<div id="bgcolor1" style="display: block;">
<form name="lform" method="post" action="adminlogincheck.php" >


		user name <input type="text" name="usrname" size="14" id="user"/> <br/> <br/>
		password  <span style="margin-left: 9px" ><input type="password" name="pwd" id="pwd1" size="14"/> </span><br/> <br/>
