...
echo"<div id='addblack'> ADD NEW BATCH </div>";
echo"<div id='adddatedis'><table>"; 
echo '<form name="batadd" action="createnadd.php" method="post">';
       echo "<tr><td>Enter joining year</td><td><input type='text' name='bat' id='bat'></td></tr>
<tr><td height=\"60\" colspan=\"2\" align=\"center\"><input type='submit' value='CREATE NEW' id='submit'></td></tr>";
        echo "</table>";
if($_REQUEST['err']==1) echo"<h3>Please Enter the Joining Year...</h3>";
...
if($_REQUEST['err']==2) echo"<h3>The given Batch already exists.....</h3>";
       echo "</div></form>";
